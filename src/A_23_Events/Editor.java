...
public class Editor extends JFrame {
  ...
  private Editor(String title) {
    ...
    openMenuItem.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        for (int i = 0; i < lines.size(); i++) editPane.setText(editPane.getText() + lines.get(i) + "\n");
    ...
    exitMenuItem.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        else System.out.println("Schließvorgang abgebrochen");
  ...
  private static String ChoosSingleFile() {
...
// int state = fc.showDialog(null, "Delete"); // freie Variante
  ...
  private static void readFileToDataStructure() {
  ...
  public void doPaste() {
    try {
      ...
      if (data != null) this.editPane.getDocument().insertString(this.editPane.getCaretPosition(), data, null);
    } catch (Exception e) {
    }
  }
